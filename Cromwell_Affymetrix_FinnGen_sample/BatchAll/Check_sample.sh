...
do
echo ${t}
for i in {01..51}      # assuming batch numbers are from 01 to 51, but actually there are no b32 and b34 currently due to these two batches have too less samples after removing samples with restricted consent (these two batches are delivered now)
do
